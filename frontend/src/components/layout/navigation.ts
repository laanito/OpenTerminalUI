export type SurfaceState = "supported" | "configuration-gated";
 ...
 * contract in a normal installation, or clearly declare that it is gated.
 * Experimental and compatibility-only routes do not belong here. See
 * docs/wiki/Surface-Inventory.md.
 */
export const PRIMARY_NAV_ITEMS: readonly TerminalNavItem[] = [
  ...
  { label: "Stat Lab", path: "/equity/stat-lab", key: "SL", hint: "Quant", state: "supported" },
  { label: "Pair Trading", path: "/equity/pair-trading", key: "PT", hint: "Quant", state: "supported" },
...
export const HIDDEN_COMPATIBILITY_ROUTES = [
  ...
  { path: "/equity/portfolio/lab", reason: "Definitions, blends, and runs are installation-wide rather than owner-scoped." },
  { path: "/backtesting/model-lab", reason: "Experiments and runs are installation-wide rather than owner-scoped." },
] as const;
