...
equity_router.include_router(screener_revamped_router, prefix="/api")
...
equity_router.include_router(commodities.router, prefix="/api")
equity_router.include_router(forex.router, prefix="/api")
equity_router.include_router(hotlists.router, prefix="/api", tags=["hotlists"])
equity_router.include_router(depth.router, prefix="/api")
equity_router.include_router(patterns.router)
...
equity_router.include_router(shareholding.router, prefix="/api")
